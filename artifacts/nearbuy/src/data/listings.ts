...
export const listings: Listing[] = [
  {
    id: 1,
    title: "Ankara Co-ord Blazer & Wide-Leg Set",
    price: 18500,
    originalPrice: 25000,
    discount: 26,
    category: "Co-ords",
    ...
    brand: "Adire House",
    imageUrl: "https://picsum.photos/seed/f1/400/500",
    images: [
      "https://picsum.photos/seed/f1/400/500",
      "https://picsum.photos/seed/f1b/400/500",
      "https://picsum.photos/seed/f1c/400/500",
    ],
    rating: 4.9,
    reviewCount: 214,
    reviews: [
    ...
    sellerAvatar: "https://picsum.photos/seed/s1/40/40",
    sellerRating: 4.9,
    sellerFollowers: 12400,
    isVerifiedSeller: true,
    badge: "Best Seller",
    colors: ["Red/Gold", "Blue/White", "Green/Orange", "Purple/Yellow"],
    clothingSizes: ["XS", "S", "M", "L", "XL", "XXL"],
    aesthetics: ["90s African Aunty", "Old Money"],
    isFeatured: true,
    tags: ["ankara", "co-ord", "owambe", "party", "corporate"],
  },
  {
    id: 2,
    title: "Baddie Bodycon Slit Dress",
    price: 12000,
    originalPrice: 18000,
    discount: 33,
    category: "Women",
    ...
    images: [
      ...
      "https://picsum.photos/seed/f2b/400/500",
      "https://picsum.photos/seed/f2c/400/500",
    ],
    rating: 4.7,
    reviewCount: 178,
    reviews: [
    ...
    freeShipping: false,
    shippingDays: 3,
    sellerName: "Glam by Nkechi",
    sellerAvatar: "https://picsum.photos/seed/s2/40/40",
    sellerRating: 4.7,
    sellerFollowers: 8900,
    isVerifiedSeller: true,
    badge: "Trending",
    colors: ["Jet Black", "Fire Red", "Cobalt Blue", "Champagne"],
    clothingSizes: ["XS", "S", "M", "L", "XL"],
    aesthetics: ["Baddie"],
    isFeatured: true,
    tags: ["bodycon", "party", "date night", "slit dress"],
  },
  {
    id: 3,
    title: "Old Money Cream Linen Blazer Set",
    price: 42000,
    originalPrice: 58000,
    discount: 28,
    category: "Co-ords",
    ...
    brand: "Lagos Luxe",
    imageUrl: "https://picsum.photos/seed/f3/400/500",
    images: [
      "https://picsum.photos/seed/f3/400/500",
      "https://picsum.photos/seed/f3b/400/500",
      "https://picsum.photos/seed/f3c/400/500",
    ],
    rating: 4.9,
    reviewCount: 93,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 2,
    sellerName: "Lagos Luxe",
    sellerAvatar: "https://picsum.photos/seed/s3/40/40",
    sellerRating: 5.0,
    sellerFollowers: 22100,
    isVerifiedSeller: true,
    badge: "Best Seller",
    colors: ["Cream", "Camel", "Sage Green", "Black"],
    clothingSizes: ["XS", "S", "M", "L", "XL"],
    aesthetics: ["Old Money", "Clean Girl"],
    isFeatured: true,
    tags: ["blazer", "linen", "luxury", "old money", "minimalist"],
  },
  {
    id: 4,
    title: "Brazilian Body Wave Lace Front Wig",
    price: 48000,
    originalPrice: 65000,
    discount: 26,
    category: "Wigs & Hair",
    description:
      "100% virgin Brazilian human hair body wave wig with HD lace frontal. 18 inches. Pre-plucked hairline with baby hairs. Bouncy, glossy, and incredibly natural-looking. Comes with adjustable straps and 2 combs.",
    imageUrl: "https://picsum.photos/seed/f4/400/500",
    images: [
      "https://picsum.photos/seed/f4/400/500",
      "https://picsum.photos/seed/f4b/400/500",
      "https://picsum.photos/seed/f4c/400/500",
    ],
    rating: 4.8,
    reviewCount: 312,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 1,
    sellerName: "Glam Wig Factory",
    sellerAvatar: "https://picsum.photos/seed/s4/40/40",
    sellerRating: 4.8,
    sellerFollowers: 31000,
    isVerifiedSeller: true,
    badge: "Hot Deal",
    colors: ["Natural Black", "Dark Brown", "Chestnut"],
    aesthetics: ["Baddie", "Clean Girl", "Old Money"],
    isFeatured: true,
    tags: ["wig", "hair", "lace front", "human hair", "brazilian"],
  },
  {
    id: 5,
    title: "Clean Girl Gold Layered Chain Set",
    price: 8500,
    originalPrice: 13000,
    discount: 35,
    ...
    images: [
      ...
      "https://picsum.photos/seed/f5b/400/500",
    ],
    rating: 4.6,
    reviewCount: 445,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 2,
    sellerName: "Lush Jewels NG",
    sellerAvatar: "https://picsum.photos/seed/s5/40/40",
    sellerRating: 4.6,
    sellerFollowers: 9800,
    isVerifiedSeller: true,
    badge: "Best Seller",
    colors: ["Gold", "Silver", "Rose Gold"],
    aesthetics: ["Clean Girl", "Old Money", "Soft Girl"],
    tags: ["jewellery", "gold", "chain", "minimal", "layered"],
  },
  {
    id: 6,
    title: "Oversized Streetwear Graphic Hoodie",
    price: 15500,
    originalPrice: 22000,
    discount: 30,
    category: "Tops",
    description:
      "Heavyweight 380GSM fleece hoodie with a bold Lagos skyline graphic. Oversized fit, kangaroo pocket, and ribbed cuffs. Heavy and warm — perfect for cool Lagos nights. This is a whole vibe.",
    imageUrl: "https://picsum.photos/seed/f6/400/500",
    images: [
      "https://picsum.photos/seed/f6/400/500",
      "https://picsum.photos/seed/f6b/400/500",
    ],
    rating: 4.8,
    reviewCount: 127,
    reviews: [
    ...
    freeShipping: false,
    shippingDays: 3,
    sellerName: "Nine01 Brand",
    sellerAvatar: "https://picsum.photos/seed/s6/40/40",
    sellerRating: 4.8,
    sellerFollowers: 15700,
    isVerifiedSeller: true,
    badge: "Trending",
    colors: ["Black", "Washed Grey", "Army Green", "Burgundy"],
    clothingSizes: ["S", "M", "L", "XL", "XXL"],
    aesthetics: ["Streetwear"],
    tags: ["hoodie", "streetwear", "graphic", "oversized", "lagos"],
  },
  {
    id: 7,
    title: "Vacay Crocheted Bikini Set",
    price: 11000,
    originalPrice: 16500,
    discount: 33,
    category: "Swimwear",
    ...
    images: [
      ...
      "https://picsum.photos/seed/f7b/400/500",
    ],
    rating: 4.7,
    reviewCount: 88,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 3,
    sellerName: "Island Girl Threads",
    sellerAvatar: "https://picsum.photos/seed/s7/40/40",
    sellerRating: 4.7,
    sellerFollowers: 6200,
    isVerifiedSeller: false,
    badge: "New",
    colors: ["White", "Coral", "Sage", "Chocolate Brown"],
    clothingSizes: ["XS", "S", "M", "L"],
    aesthetics: ["Vacay", "Boho"],
    tags: ["bikini", "swimwear", "beach", "crochet", "vacay"],
  },
  {
    id: 8,
    title: "Boho Floral Chiffon Maxi Dress",
    price: 22000,
    originalPrice: 30000,
    discount: 27,
    category: "Women",
    ...
    images: [
      ...
      "https://picsum.photos/seed/f8b/400/500",
    ],
    rating: 4.8,
    reviewCount: 156,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 2,
    sellerName: "Bloom & Thread",
    sellerAvatar: "https://picsum.photos/seed/s8/40/40",
    sellerRating: 4.8,
    sellerFollowers: 11200,
    isVerifiedSeller: true,
    badge: "Best Seller",
    colors: ["Tropical Blue", "Dusty Rose", "Ivory/Green"],
    clothingSizes: ["XS", "S", "M", "L", "XL"],
    aesthetics: ["Boho", "Vacay", "Soft Girl"],
    tags: ["maxi dress", "floral", "boho", "chiffon", "wedding guest"],
  },
  {
    id: 9,
    ...
    category: "Sneakers",
    description:
      "90s-inspired chunky platform sneakers with a 4cm sole. Genuine leather upper, cushioned insole. A streetwear and clean-girl staple that elevates any outfit — from miniskirts to wide-leg jeans.",
    imageUrl: "https://picsum.photos/seed/f9/400/500",
    images: [
      "https://picsum.photos/seed/f9/400/500",
      "https://picsum.photos/seed/f9b/400/500",
    ],
    rating: 4.7,
    reviewCount: 203,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 2,
    sellerName: "Sole Story NG",
    sellerAvatar: "https://picsum.photos/seed/s9/40/40",
    sellerRating: 4.7,
    sellerFollowers: 18500,
    isVerifiedSeller: true,
    badge: "Trending",
    colors: ["Triple White", "Black/White", "Cream/Brown"],
    shoeSizes: ["36", "37", "38", "39", "40", "41", "42"],
    aesthetics: ["Clean Girl", "Streetwear", "90s African Aunty"],
    tags: ["sneakers", "platform", "chunky", "shoes"],
  },
  {
    id: 10,
    title: "Soft Girl Satin Slip Pyjama Set",
    price: 14000,
    originalPrice: 19500,
    discount: 28,
    ...
    images: [
      ...
      "https://picsum.photos/seed/f10b/400/500",
    ],
    rating: 4.9,
    reviewCount: 267,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 2,
    sellerName: "Lush Luxe Loungewear",
    sellerAvatar: "https://picsum.photos/seed/s10/40/40",
    sellerRating: 4.9,
    sellerFollowers: 14300,
    isVerifiedSeller: true,
    badge: "Best Seller",
    colors: ["Dusty Rose", "Baby Blue", "Lilac", "Champagne"],
    clothingSizes: ["XS", "S", "M", "L", "XL"],
    aesthetics: ["Soft Girl"],
    tags: ["pyjama", "satin", "sleepwear", "soft girl", "loungewear"],
  },
  {
    id: 11,
    title: "90s Aunty Kente Print Blouse",
    price: 9500,
    originalPrice: 14000,
    discount: 32,
    category: "Tops",
    description:
      "A proud celebration of African fashion. Bold kente-inspired print blouse with structured shoulders and peplum hem. Pairs beautifully with plain wide-leg trousers or a midi skirt. The spirit of the 90s African aunty — iconic, unbothered, and dripped.",
    imageUrl: "https://picsum.photos/seed/f11/400/500",
    images: [
      "https://picsum.photos/seed/f11/400/500",
      "https://picsum.photos/seed/f11b/400/500",
    ],
    rating: 4.8,
    reviewCount: 134,
    reviews: [
    ...
    sellerFollowers: 12400,
    isVerifiedSeller: true,
    colors: ["Multi-Kente", "Blue/Gold", "Red/Black"],
    clothingSizes: ["XS", "S", "M", "L", "XL", "XXL"],
    aesthetics: ["90s African Aunty"],
    tags: ["kente", "african print", "blouse", "peplum", "top"],
  },
  {
    id: 12,
    title: "Gym Set – Sports Bra & High Waist Leggings",
    price: 19500,
    originalPrice: 27000,
    discount: 28,
    category: "Gym Wear",
    description:
      "Squat-proof, sweat-wicking gym set. Sports bra with built-in padding and matching high-waist leggings with ribbed waistband. Sculpting fit that hugs your curves perfectly. Available in rich, vibrant colours.",
    imageUrl: "https://picsum.photos/seed/f12/400/500",
    images: [
      "https://picsum.photos/seed/f12/400/500",
      "https://picsum.photos/seed/f12b/400/500",
    ],
    rating: 4.9,
    reviewCount: 389,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 2,
    sellerName: "FitGirl NG",
    sellerAvatar: "https://picsum.photos/seed/s12/40/40",
    sellerRating: 4.9,
    sellerFollowers: 26800,
    isVerifiedSeller: true,
    badge: "Best Seller",
    colors: ["Burnt Orange", "Deep Purple", "Forest Green", "Black", "Hot Pink"],
    clothingSizes: ["XS", "S", "M", "L", "XL"],
    aesthetics: ["Clean Girl", "Baddie"],
    isFeatured: true,
    tags: ["gym", "leggings", "sports bra", "fitness", "workout"],
  },
  {
    id: 13,
    title: "Clear Rhinestone Barely There Heels",
    price: 32000,
    originalPrice: 45000,
    discount: 29,
    category: "Heels",
    ...
    images: [
      ...
      "https://picsum.photos/seed/f13b/400/500",
    ],
    rating: 4.6,
    reviewCount: 178,
    reviews: [
    ...
    isVerifiedSeller: true,
    badge: "Trending",
    colors: ["Clear/Crystal", "Gold Rhinestone", "Silver Rhinestone"],
    shoeSizes: ["36", "37", "38", "39", "40", "41"],
    aesthetics: ["Baddie", "Old Money"],
    tags: ["heels", "rhinestone", "glam", "party shoes", "stiletto"],
  },
  {
    id: 14,
    title: "Black Girl Glow Vitamin C Serum",
    price: 7500,
    originalPrice: 10000,
    discount: 25,
    category: "Beauty",
    description:
      "Formulated specifically for melanin-rich skin. 20% Vitamin C + Niacinamide + Hyaluronic Acid. Fades dark spots, hyperpigmentation, and post-blemish marks. Dermatologist-tested, cruelty-free, and made in Nigeria.",
    brand: "Glow Ritual",
    imageUrl: "https://picsum.photos/seed/f14/400/500",
    images: [
      "https://picsum.photos/seed/f14/400/500",
      "https://picsum.photos/seed/f14b/400/500",
    ],
    rating: 4.9,
    reviewCount: 521,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 1,
    sellerName: "Glow Ritual",
    sellerAvatar: "https://picsum.photos/seed/s14/40/40",
    sellerRating: 5.0,
    sellerFollowers: 44200,
    isVerifiedSeller: true,
    badge: "Best Seller",
    aesthetics: ["Clean Girl"],
    isFeatured: true,
    tags: ["skincare", "vitamin c", "serum", "glow", "dark spots"],
  },
  {
    id: 15,
    title: "Denim Corset Crop Top",
    price: 13500,
    originalPrice: 19000,
    discount: 29,
    category: "Denim",
    ...
    images: [
      ...
      "https://picsum.photos/seed/f15b/400/500",
    ],
    rating: 4.7,
    reviewCount: 143,
    reviews: [
    ...
    sellerFollowers: 8900,
    isVerifiedSeller: true,
    colors: ["Classic Blue", "Black Denim", "White Denim"],
    clothingSizes: ["XS", "S", "M", "L"],
    aesthetics: ["Baddie", "Streetwear", "Old Money"],
    tags: ["denim", "corset", "crop top", "top"],
  },
  {
    id: 16,
    title: "Plus Size Wrap Midi Dress",
    price: 16500,
    originalPrice: 23000,
    discount: 28,
    category: "Plus Size Fashion",
    description:
      "A gorgeous flowy wrap midi dress that celebrates all body types. Adjustable tie waist flatters your curves beautifully. Soft, breathable fabric. Available in extended sizes 14–24. You deserve to slay too!",
    imageUrl: "https://picsum.photos/seed/f16/400/500",
    images: [
      "https://picsum.photos/seed/f16/400/500",
      "https://picsum.photos/seed/f16b/400/500",
    ],
    rating: 4.9,
    reviewCount: 287,
    reviews: [
    ...
    freeShipping: true,
    shippingDays: 2,
    sellerName: "Curves & Co.",
    sellerAvatar: "https://picsum.photos/seed/s16/40/40",
    sellerRating: 4.9,
    sellerFollowers: 19600,
    isVerifiedSeller: true,
    badge: "Best Seller",
    colors: ["Burgundy", "Forest Green", "Navy Print", "Terracotta"],
    clothingSizes: ["14", "16", "18", "20", "22", "24"],
    aesthetics: ["Old Money", "Boho"],
    tags: ["plus size", "wrap dress", "midi", "curvy", "inclusive"],
  },
  {
    id: 17,
    title: "Thrift: Y2K Butterfly Print Mini Skirt",
    price: 6000,
    originalPrice: undefined,
    category: "Bottoms",
    description:
      "One-of-one vintage Y2K butterfly print mini skirt. Genuine 2000s era piece. A4 sizing (approx UK 10). In excellent condition with no tears or stains. You won't find another one like it — deposit required to secure.",
    imageUrl: "https://picsum.photos/seed/t1/400/500",
    images: [
      "https://picsum.photos/seed/t1/400/500",
      "https://picsum.photos/seed/t1b/400/500",
    ],
    rating: 5.0,
    reviewCount: 3,
    reviews: [
    ...
    freeShipping: false,
    shippingDays: 4,
    sellerName: "Thrift Queen NG",
    sellerAvatar: "https://picsum.photos/seed/st1/40/40",
    sellerRating: 4.8,
    sellerFollowers: 7200,
    isVerifiedSeller: true,
    badge: "Limited",
    colors: ["Multicolour"],
    clothingSizes: ["S"],
    aesthetics: ["90s African Aunty", "Boho"],
    isThrift: true,
    depositAmount: 2500,
    tags: ["thrift", "vintage", "y2k", "mini skirt", "one of one"],
  },
  {
    id: 18,
    title: "Thrift: Vintage Corduroy Blazer",
    price: 8500,
    originalPrice: undefined,
    category: "Clothing",
    description:
      "Authentic 1990s tan corduroy blazer. Fully lined, brass button detail, wide lapels. One-of-one — only 1 available. Perfect size M (UK 12). No moth holes, no stains. Deep thrift find that deserves a new home.",
    imageUrl: "https://picsum.photos/seed/t2/400/500",
    images: [
      "https://picsum.photos/seed/t2/400/500",
      "https://picsum.photos/seed/t2b/400/500",
    ],
    rating: 4.9,
    reviewCount: 5,
    reviews: [
    ...
    colors: ["Tan Corduroy"],
    clothingSizes: ["M"],
    aesthetics: ["Old Money", "90s African Aunty", "Boho"],
    isThrift: true,
    depositAmount: 3000,
    tags: ["thrift", "vintage", "blazer", "corduroy", "one of one"],
  },
  {
    id: 19,
    title: "Thrift: 90s Band Tee – Fela Kuti",
    price: 12000,
    category: "Tops",
    description:
      "Rare authentic 1990s Fela Kuti concert tee. Faded, worn-in perfection. Size L. This is a genuine piece of Nigerian music history in wearable form. Only 1 exists — deposit to secure.",
    imageUrl: "https://picsum.photos/seed/t3/400/500",
    images: [
      "https://picsum.photos/seed/t3/400/500",
      "https://picsum.photos/seed/t3b/400/500",
    ],
    rating: 5.0,
    reviewCount: 8,
    reviews: [
    ...
    freeShipping: false,
    shippingDays: 4,
    sellerName: "Afro Vintage Co.",
    sellerAvatar: "https://picsum.photos/seed/st2/40/40",
    sellerRating: 5.0,
    sellerFollowers: 5400,
    isVerifiedSeller: true,
    badge: "Limited",
    colors: ["Faded Black"],
    clothingSizes: ["L"],
    aesthetics: ["Streetwear", "90s African Aunty"],
    isThrift: true,
    depositAmount: 4000,
    tags: ["thrift", "vintage", "fela kuti", "band tee", "nigerian"],
  },
];
