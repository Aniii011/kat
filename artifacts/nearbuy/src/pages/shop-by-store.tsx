...
import {
  ArrowLeft, Star, BadgeCheck, Package, ShoppingBag,
  Search, CheckCircle2, Store as StoreIcon, Flag,
} from "lucide-react";
...
export default function ShopByStore() {
  const [, params] = useRoute("/shop/:storeId");
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-1 mt-1">
                ...
                <span className="text-xs text-muted-foreground ml-1">
                  On KAT since {new Date(store.created_at).toLocaleDateString("en-NG", { month: "short", year: "numeric" })}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="pt-4 pb-2">
          ...
          >
            <Flag className="w-3.5 h-3.5" /> Report this store
          </button>
        </div>
      </div>
    </div>
