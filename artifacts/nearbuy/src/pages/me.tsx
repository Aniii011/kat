              ...
              {editingName ? (
                <div className="flex gap-2">
                  <Input
                    ...
                    autoFocus
                  />
                  <Button size="sm" onClick={saveName} className="rounded-xl px-3 h-8">
                    Save
                  </Button>
                </div>
              ) : (
          ...
          <div className="bg-card border border-card-border rounded-2xl p-4 space-y-3">
            ...
            {editingAddress ? (
              <div className="space-y-2">
                ...
                />
                <div className="flex gap-2">
                  <Button size="sm" onClick={saveAddress} className="rounded-full">
                    Save Address
                  </Button>
                  <Button
                    size="sm"
        ...
        <div className="bg-card border border-card-border rounded-2xl p-4 space-y-4">
          ...
          <div className="bg-muted rounded-xl p-3 flex items-center gap-2">
            ...
            <span
              ...
              style={{ background: theme.base === "white" ? "#ffffff" : "#0d0d0d" }}
            />
